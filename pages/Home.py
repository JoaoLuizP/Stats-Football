...
def load_data(temp):
    ...
    BUNDES_1 = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Germany%20Bundesliga_{temp_1}.xlsx"
    )
    BUNDES_2 = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Germany%202.%20Bundesliga_{temp_1}.xlsx"
    )
    BUNDES01 = [BUNDES_1, BUNDES_2]
    BUNDES = pd.concat(BUNDES01)
    # Austria
    AUT = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Austria%20Bundesliga_{temp_1}.xlsx")
    # Argentina
    ARG = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Argentina%20Primera%20Divisi%C3%B3n_{temp_1_0}.xlsx")
    # Brasil
    BR1_01 = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Brazil%20Serie%20A_{temp_1_0}.xlsx")
    BR1_02 = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Brazil%20Serie%20B_{temp_1_0}.xlsx")
    BR1 = [BR1_01, BR1_02]
    BR = pd.concat(BR1)
    # Belgica
    BEL = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Belgium%20Pro%20League_{temp_1}.xlsx")
    # Croacia
    CRO = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Croatia%20Prva%20HNL_{temp_1}.xlsx"
    )
    # Chile
    CHI_01 = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Chile%20Primera%20Divisi%C3%B3n_{temp_1_0}.xlsx")
    CHILE = [CHI_01]
    CHI = pd.concat(CHILE)
    # China
    CHINA = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/China%20Chinese%20Super%20League_{temp_1_0}.xlsx")
    # Dinamarca
    DIN = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Denmark%20Superliga_{temp_1}.xlsx"
    )
    # França
    FRA_01 = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/France%20Ligue%201_{temp_1}.xlsx"
    )
    FRA_O2 = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/France%20Ligue%202_{temp_1}.xlsx"
    )
    FRA01 = [FRA_01, FRA_O2]
    FRA = pd.concat(FRA01)
    # Finlandia
    FIN = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Finland%20Veikkausliiga_{temp_1_0}.xlsx"
    )
    # Holanda
    HOL_01 = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Netherlands%20Eredivisie_{temp_1}.xlsx"
    )
    HOL_02 = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Netherlands%20Eerste%20Divisie_{temp_1}.xlsx"
    )
    HOL01 = [HOL_01, HOL_02]
    HOL = pd.concat(HOL01)
    # Estonia
    EST = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Estonia%20Meistriliiga_{temp_1_0}.xlsx"
    )
    # Egito
    EGYPT = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/refs/heads/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Egypt%20Egyptian%20Premier%20League_{temp_1}.xlsx"
    )
    # Inglaterra
    ING_PL = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/England%20Premier%20League_{temp_1}.xlsx"
    )
    ING_2 = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/England%20Championship_{temp_1}.xlsx"
    )
    ING_3 = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/England%20EFL%20League%20One_{temp_1}.xlsx"
    )
    ING1 = [ING_PL, ING_2, ING_3]
    ING = pd.concat(ING1)
    # Italia
    ITA_01 = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Italy%20Serie%20A_{temp_1}.xlsx"
    )
    ITA_02 = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Italy%20Serie%20B_{temp_1}.xlsx"
    )
    ITA01 = [ITA_01, ITA_02]
    ITA = pd.concat(ITA01)
    # Japao
    JAP_01 = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Japan%20J1%20League_{temp_1_0}.xlsx")
    JAP_02 = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Japan%20J2%20League_{temp_1_0}.xlsx")
    JAP1 = [JAP_01, JAP_02]
    JAP = pd.concat(JAP1)
    # Noruega
    NOR = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Norway%20Eliteserien_{temp_1_0}.xlsx")
    # Paraguai
    PAR = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Paraguay%20Division%20Profesional_{temp_1_0}.xlsx")
    # Portugal
    PORT_O1 = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Portugal%20Liga%20NOS_{temp_1}.xlsx")
    PORT_O2 = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Portugal%20LigaPro_{temp_1}.xlsx")
    PORT01 = [PORT_O1, PORT_O2]
    PORT = pd.concat(PORT01)
    # Romenia
    ROM = pd.read_excel(f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Romania%20Liga%20I_{temp_1}.xlsx")
    # Scotland
    SCOT = pd.read_excel(f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Scotland%20Premiership_{temp_1}.xlsx")
    # Spain
    SPAIN_01 = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Spain%20La%20Liga_{temp_1}.xlsx")
    SPAIN_02 = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Spain%20Segunda%20Divisi%C3%B3n_{temp_1}.xlsx")
    SPAIN01 = [SPAIN_01, SPAIN_02]
    SPAIN = pd.concat(SPAIN01)
    # Coreia do Sul
    COR = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/South%20Korea%20K%20League%201_{temp_1_0}.xlsx")
    # Suiça
    SUI_O1 = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Switzerland%20Super%20League_{temp_1}.xlsx")
    SUI_02 = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Switzerland%20Challenge%20League_{temp_1}.xlsx")
    SUIO1 = [SUI_O1, SUI_02]
    SUI = pd.concat(SUIO1)
    # Suécia
    SWE_01 = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Sweden%20Allsvenskan_{temp_1_0}.xlsx")
    SWE_02 = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Sweden%20Superettan_{temp_1_0}.xlsx")
    SWE_BOTHS = [SWE_01, SWE_02]
    SWE = pd.concat(SWE_BOTHS)
    # EUA
    MLS = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/USA%20MLS_{temp_1_0}.xlsx")
    EUA1 = [MLS]
    EUA = pd.concat(EUA1)
    # Uruguai
    URU = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Uruguay%20Primera%20Divisi%C3%B3n_{temp_1_0}.xlsx")
    # Turquia
    TUR = pd.read_excel(
        f"https://github.com/futpythontrader/YouTube/raw/main/Bases_de_Dados/FootyStats/Bases_de_Dados_(2022-2025)/Turkey%20S%C3%BCper%20Lig_{temp_1}.xlsx")
